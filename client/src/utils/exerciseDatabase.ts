// Local exercise database for validating parsed exercise names
...
const EXERCISES: Exercise[] = [
  ...
  { name: 'Tricep Extension', category: 'push', isBodyweight: false, aliases: ['skull crushers', 'triceps extension', 'lying tricep extension'] },
  { name: 'Tricep Pushdown', category: 'push', isBodyweight: false, aliases: ['triceps pushdown', 'tricep push down', 'cable pushdown', 'rope pushdown'] },
  ...
  { name: 'Dumbbell Row', category: 'pull', isBodyweight: false, aliases: ['db row', 'single arm row', 'dumbell row', 'dumbbell rows'] },
  ...
  { name: 'Bicep Curl', category: 'pull', isBodyweight: false, aliases: ['curls', 'biceps curl', 'curl', 'bicep curls', 'biceps curls'] },
  ...
  { name: 'Leg Curl', category: 'legs', isBodyweight: false, aliases: ['leg curls', 'hamstring curl', 'hamstring curls', 'lying leg curl', 'seated leg curl'] },
